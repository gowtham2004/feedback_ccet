...
<nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary bg-primary" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <a class="navbar-brand" href="./">
                <img src="https://www.chettinadtech.ac.in/intranet_login_assets/images/college_icon.jpg"
                    alt="Chettinad CET" class="ccet_logo" height="40" width="40">
            </a>
